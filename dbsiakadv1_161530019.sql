...
--
-- Host: 127.0.0.1
-- Generation Time: 28 Des 2017 pada 21.34
...
INSERT INTO `tb_user` (`id_user`, `nama_user`, `pass`, `lev_user`) VALUES
('002', 'putra', '21232f297a57a5a743894a0e4a801fc3', 'Kemahasiswaan'),
('ID001', 'ridwan', 'd584c96e6c1ba3ca448426f66e552e8e', 'Administrator'),
('ID003', 'agung', '123456', 'Staff Kemahasiswaan');
...
--
ALTER TABLE `tbmahasiswa`
  ADD CONSTRAINT `tbmahasiswa_ibfk_1` FOREIGN KEY (`id_ta`) REFERENCES `tbthangkatan` (`id_ta`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tbmahasiswa_ibfk_2` FOREIGN KEY (`kd_prodi`) REFERENCES `tbprodi` (`kd_prodi`) ON DELETE CASCADE;

--
-- Ketidakleluasaan untuk tabel `tbprodi`
--
ALTER TABLE `tbprodi`
  ADD CONSTRAINT `tbprodi_ibfk_1` FOREIGN KEY (`kd_jur`) REFERENCES `tbjurusan` (`kd_jur`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
